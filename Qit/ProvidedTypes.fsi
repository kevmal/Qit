...
type ProvidedProperty =
    ...
    new: propertyName: string * propertyType: Type * ?getterCode: (Expr list -> Expr) * ?setterCode: (Expr list -> Expr) * ?isStatic: bool * ?indexParameters: ProvidedParameter list * ?pattrs : MethodAttributes -> ProvidedProperty
...
type ProvidedTypesContext = 
    ...
    member ConvertSourceProvidedTypeDefinitionToTarget : ProvidedTypeDefinition -> ProvidedTypeDefinition
